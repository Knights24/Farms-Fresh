...
export const orders: Order[] = [
  {
    ...
    items: [
      { id: '1', name: 'Fresh Mangoes', price: 150, quantity: 2, imageUrl: 'https://picsum.photos/400/300' },
      { id: '3', name: 'Paneer', price: 400, quantity: 1, imageUrl: 'https://picsum.photos/400/300' },
    ],
    total: 700,
  },
  {
    ...
    items: [
      { id: '2', name: 'Okra (Bhindi)', price: 60, quantity: 1, imageUrl: 'https://picsum.photos/400/300' },
    ],
    total: 60,
  },
];
